...
export const INFO = "info"; // info, warning, danger, or success. If
...
export const TITLE_LOGIN_FAIL = "Login Fail";
...
export const TITLE_CREATE_FAIL = "Create Fail";
export const TITLE_CREATE_SUCCESS = "Create Success";
