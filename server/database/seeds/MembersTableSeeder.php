...
class MembersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('members')->insert([
            ...
            array('del_flag' => false, 'email' => 'dinhhanh97.ptit@gmail.com', 'password' => md5('123456'), 'fullname' => 'Dương Đình Hạnh', 'is_male' => true, 'birthday' => '1997-04-25', 'phone' => '0929339197', 'picture' => 'avatar_2.png', 'role' => 2, 'created_at' => Carbon::now('Asia/Ho_Chi_Minh'), 'updated_at' => Carbon::now('Asia/Ho_Chi_Minh'))
        ]);
    }
}
